...
//namespace src\app\core\Transportation\Bus;
...
class Bus extends AbstractTransportation
{
    ...
    const MESSAGE_NO_SEAT = 'No seat assignment.<br/>';
    ...
    {
        $message = sprintf(static::MESSAGE . static::MESSAGE_FROM_TO, $this->departure,
            $this->arrival);
